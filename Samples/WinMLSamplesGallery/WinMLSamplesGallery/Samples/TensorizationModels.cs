...
#pragma warning disable CA1416 // Validate platform compatibility
        public static LearningModel TopK(long topk, long batchSize, long nClasses)
        {
            var builder = LearningModelBuilder.Create(13)
                            .Inputs.Add(LearningModelBuilder.CreateTensorFeatureDescriptor("ClassifierOutput", TensorKind.Float, new long[] { batchSize, nClasses }))
        ...
        public static LearningModel SoftMaxThenTopK(long topk, long batchSize, long nClasses)
        {
            var builder = LearningModelBuilder.Create(13)
                            .Inputs.Add(LearningModelBuilder.CreateTensorFeatureDescriptor("ClassifierOutput", TensorKind.Float, new long[] { batchSize, nClasses }))
                            .Outputs.Add(LearningModelBuilder.CreateTensorFeatureDescriptor("TopKValues", TensorKind.Float, new long[] { batchSize, topk }))
