    ...
    int& numCubeIndices)
{
    ...
    CD3DX12_CPU_DESCRIPTOR_HANDLE rtvHandle = UpdatePipeline(commandAllocator,
        frameIndex, Running, commandList, pipelineStateObject,
        renderTargets, rtvDescriptorHeap, dsDescriptorHeap,
        rtvDescriptorSize, swapChain, fence, fenceValue, fenceEvent, rootSignature,
        mainDescriptorHeap, viewport, scissorRect, vertexBufferView,
        indexBufferView, constantBufferUploadHeaps, numCubeIndices); // update the pipeline by sending commands to the commandqueue
